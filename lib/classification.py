...
class word2vec_analyzer():
    ...
    def __init__(self, path_to_data, path_to_embeddings, vectorizer, sample_size):
        ...
        if path_to_data.replace('.', '/').split('/')[-2] == 'dataset_vermeer':
            self.train_sizes = [10, 40, 160, 640, 1000, 2500, 3386]
        elif path_to_data.replace('.', '/').split('/')[-2] == 'dataset_burscher':
            self.train_sizes = [10, 40, 160, 640, 1000, 2500, 5000, 7500, 10000, 12459]
